...
namespace CSMongo.DataTypes {
    ...
    /// </summary>
    public class SmallEnumeratedType : MongoDataType {

        #region Constants

        //shared types to check for maximum ranges
        internal static readonly Type _UInt64 = typeof(ulong);
        internal static readonly Type _Int64 = typeof(long);
        internal static readonly Type _UInt32 = typeof(uint);
        ...
        public override byte[] ToBson() {
            return BsonTranslator.AsInt32(this.Value as int? ?? 0);
        }
